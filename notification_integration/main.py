...
config_map = {
    'tf-topic-cpu': {
        ...
        'msg_format': 'card',
        'webhook_url': 'https://chat.googleapis.com/v1/spaces/AAAA6L0RC-8/messages?key=AIzaSyDdI0hCZtE6vySjMm-WEfRq3CPzqKqqsHI&token=y3OiQwF_1l0e249W6qtGhfo_LouWXkiE2RhXyWYm-6M'},
}
